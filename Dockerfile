...
ARG ROOTFS_URL=https://github.com/slurmorg/build-containers-trusted/blob/main/rootfs.tar.gz
ARG MAVEN_URL=https://github.com/slurmorg/build-containers-trusted/blob/main/apache-maven-3.9.1-bin.tar.gz
ARG TOMCAT_URL=https://github.com/slurmorg/build-containers-trusted/blob/main/apache-tomcat-10.1.7.tar.gz
...
RUN curl -sLJO --compressed ${GPG_KEY_URL} \
